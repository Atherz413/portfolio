export const siteConfig = {
  ...
  tagline: "I build backend systems and ship them to production.",
  subTagline:
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A mini CRM pipeline managing the full lead lifecycle for a sales team across multiple lead sources — built inside Google Sheets for a 100+ client agency.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "A config-driven ETL pipeline ingesting data from 7 ad channels per client, transforming and routing it to dashboards — serving ~150 reports from a single codebase.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Full tracking setups for production clients across e-commerce and lead generation — with custom deduplication and cross-platform event validation.",
    highlights: [
...
export const about = {
  ...
  values: ["Production systems over tutorials", "AI-native workflow", "Ownership mindset"],
};