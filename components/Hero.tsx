    ...
    <div id="hero" className="flex flex-col md:flex-row min-h-screen pt-[48px]">
      ...
      <section className="relative w-full md:w-[30%] bg-[#070710] md:bg-[#00489f] border-r-2 border-[#4fc3f7] flex flex-col justify-center items-center py-20 md:py-0 overflow-hidden">
        ...
        <div className="vertical-text relative z-10">
          <span className="block md:hidden font-label-caps text-[#FFFFFF] tracking-widest uppercase text-[14px]">01 — PORTFOLIO / 2026</span>
          <h1 className="hidden md:block font-headline-xl text-headline-xl text-white tracking-tighter select-none">
            PORTFOLIO
          </h1>
        </div>
        ...
        <div className="hidden md:block absolute bottom-10 left-10 z-10">
          <p className="font-label-caps text-[#FFFFFF] tracking-widest uppercase text-[14px]">PORTFOLIO / 2026</p>
        </div>
